...
using OsEngine.Models.Logging.Servers;
...
namespace OsEngine.Views.Logging
{
    ...
    /// </summary>
    public partial class MessageSenderUi : Window
    {
        /// <summary>
        ...
        private void LoadDateOnForm()
        {
            ...
            {
                ComboBoxModeWebhook.SelectedItem = OsLocalization.Logging.Label1;
            }
            else
            {
                ComboBoxModeWebhook.SelectedItem = OsLocalization.Logging.Label2;
            }
            ...
            {
                ComboBoxModeTelegram.SelectedItem = OsLocalization.Logging.Label1;
            }
            else
            {
                ComboBoxModeTelegram.SelectedItem = OsLocalization.Logging.Label2;
            }
            ...
            {
                ComboBoxModeMail.SelectedItem = OsLocalization.Logging.Label1;
            }
            else
            {
                ComboBoxModeMail.SelectedItem = OsLocalization.Logging.Label2;
            }
            ...
            {
                ComboBoxModeSms.SelectedItem = OsLocalization.Logging.Label1;
            }
            else
            {
                ComboBoxModeSms.SelectedItem = OsLocalization.Logging.Label2;
            }
        ...
        private void Save()
        {
            if (ComboBoxModeWebhook.SelectedItem.ToString() == OsLocalization.Logging.Label1)
            {
            ...
            if (ComboBoxModeTelegram.SelectedItem.ToString() == OsLocalization.Logging.Label1)
            {
            ...
            if (ComboBoxModeMail.SelectedItem.ToString() == OsLocalization.Logging.Label1)
            {
            ...
            if (ComboBoxModeSms.SelectedItem.ToString() == OsLocalization.Logging.Label1)
            {
        ...
        private void ComboBoxModeMail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
