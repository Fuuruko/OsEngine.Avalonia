...
namespace OsEngine.Models.Terminal
{
    public class IcebergMaker
    {
        ...
        public void MakeNewIceberg(decimal price, TimeSpan lifeTime, int ordersCount,
            Position position, IcebergType type, decimal volume, SimpleBot bot, OrderPriceType priceType, int minMillisecondsDistanceMarketOrders)
        {
            _icebergOrders ??= [];

            Iceberg newIceberg = new(price, lifeTime, ordersCount, position,
        ...
        {
            NewOrderNeedToExecute?.Invoke(order);
        }
        ...
        {
            NewOrderNeedToCancel?.Invoke(order);
        }
    ...
    public class Iceberg
    {
        ...
        public Iceberg(decimal price, TimeSpan lifeTime, int ordersCount,
            Position position, SimpleBot bot, IcebergType type,
        ...
        public void Check()
        {
               ...
               _lastOrderState == OrderStateType.Done)
            {
                ...
                NewOrderNeedToExecute?.Invoke(_ordersInSystem);
