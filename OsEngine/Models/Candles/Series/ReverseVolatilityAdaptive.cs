...
public class ReverseVolatilityAdaptive : ACandlesSeriesRealization
{
    ...
    private void RebuildCandlesCount()
    {
        ...
        if (volaInDaysAbs.Count == 0 || volaInDaysPercent.Count == 0) { return; }
        ...
        for (i = 0; i < volaInDaysAbs.Count; i++)
        {
        ...
        var volatilityDivider = VolatilityDivider.ValueInt;
        var pointsMinMoveVolatilityMult = PointsMinMoveVolatilityMult.ValueDecimal;

        decimal volaAbsOneCandle = volaAbsSma / volatilityDivider;
        decimal volaPercentOneCandle = volaPercentSma / volatilityDivider;

        decimal oneCandleMinMoveAbs = volaAbsOneCandle * pointsMinMoveVolatilityMult;
        decimal oneCandleMinMovePercent = volaPercentOneCandle * pointsMinMoveVolatilityMult;
