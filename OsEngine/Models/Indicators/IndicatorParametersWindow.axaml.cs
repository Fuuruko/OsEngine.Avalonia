...
namespace OsEngine.Views.Indicators
{
    /// <summary>
    /// Interaction logic for AIndicatorUi.xaml
    /// </summary>
    public partial class IndicatorParametersWindow : Window
    {
        private BaseIndicator _indicator;

        public IndicatorParametersWindow(BaseIndicator indicator)
        {
            InitializeComponent();
