...
using OsEngine.Models.Market.Servers.Finam.Entity;
...
public partial class Finam : BaseServer, IHideParameters, IFeedServer
{
    ...
    public override void Connect(WebProxy proxy)
    {
    ...
    public override List<Portfolio> GetPortfolios()
    {
        throw new NotImplementedException();
    }
    ...
    public List<Trade> IGetCandles(Security security, DateTime startTime, DateTime endTime)
    {
        throw new NotImplementedException();
    }

    public List<Trade> IGetTrades(Security security, DateTime startTime, DateTime endTime)
    {
        throw new NotImplementedException();
    }

    public override void ISubscribe(Security security)
    {
        throw new NotImplementedException();
    }

    public override void ISubscribeNews()
    {
        throw new NotImplementedException();
    }

    protected override void ICancelAllOrders(Security security = null)
    {
        throw new NotImplementedException();
    }

    protected override void ICancelAllOrdersToSecurity(Security security)
    {
        throw new NotImplementedException();
    }

    protected override bool ICancelOrder(Order order)
    {
        throw new NotImplementedException();
    }

    protected override void IChangeOrderPrice(Order order, decimal newPrice)
    {
        throw new NotImplementedException();
    }

    protected override List<Order> IGetActiveOrders()
    {
        throw new NotImplementedException();
    }

    protected override List<Candle> IGetCandles(Security security, TimeFrame timeFrame,
            DateTime startTime, DateTime endTime, DateTime actualTime)
    {
        throw new NotImplementedException();
    }

    protected override List<Candle> IGetLastCandleHistory(Security security, TimeFrame timeFrame, int candleCount)
    {
        throw new NotImplementedException();
    }

    protected override OrderStateType IGetOrderStatus(Order order)
    {
        throw new NotImplementedException();
    }

    protected override List<Trade> IGetTrades(Security security,
            DateTime startTime, DateTime endTime, DateTime actualTime)
    {
        throw new NotImplementedException();
    }

    protected override void ISendOrder(Order order)
    {
        throw new NotImplementedException();
    }
}
...
public class FinamServerRealization : IServerRealization
{
    ...
    private Dictionary<string, string> _rusIndexNames = new()
     {
    ...
    public void GetSecurities()
    {
        ...
        arrayCodes[0] = arrayCodes[0][1..];
        for (int i = 1; i < arrayCodes.Length; i++)
        {
            arrayCodes[i] = arrayCodes[i][2..];
        }
        ...
        {
            arrayMarkets[i] = arrayMarkets[i][1..];
        }
        ...
        HashSet<string> unavailableSecHashSet = [.. unavailableSecurities];
        ...
        for (int i = 0; i < arrayIds.Length; i++)
        {
            ...
            FinamSecurity finamSecurity = new()
            {
                Code = arrayCodes[i].TrimStart('\'').TrimEnd('\''),
        ...
        for (int i = 0; i < _finamSecurities.Count; i++)
        {
            ...
            Security sec = new()
            {
                NameFull = _finamSecurities[i].Code,
                Name = _finamSecurities[i].Name,
                NameId = _finamSecurities[i].Id,
                NameClass = _finamSecurities[i].Market,
                PriceStep = 0,
                PriceStepCost = 0
            };
    ...
    public static string GetPage(string uri)
    {
        try
        {
            ...
            using (StreamReader sr = new(response.GetResponseStream(), Encoding.Default, true))
            {
    ...
    private static string GetSecFromFile()
    {
        ...
        try
        {
            using StreamReader reader = new(@"FinamSecurities.txt");
    ...
    private List<Portfolio> _myPortfolios = [];

    public void GetPortfolios()
    {
        Portfolio newPortfolio = new()
        {
            Number = "Finam Virtual Portfolio",
            ValueCurrent = 1
        };
    ...
    public List<Candle> GetCandleDataToSecurity(Security security, TimeFrameBuilder timeFrameBuilder, DateTime startTime, DateTime endTime, DateTime actualTime)
    {
        try
        {
            ...
            FinamDataSeries finamDataSeries = new()
            {
                ServerPrefics = "http://" + _serverAddress,
                TimeActual = actualTime,
                Security = security,
                SecurityFinam = _finamSecurities.Find(s => s.Id == security.NameId),
