...
namespace OsEngine.Models.Market.Servers
{
    ...
    {
        // static ServerPermissions Permissions { get; }
        ServerPermissions Permissions { get; }
        // List<IBaseInput> Inputs { get; }
        ...
        /// subscribe to news
        /// </summary>
        bool SubscribeNews() { return false; }
        ...
        public List<Candle> GetCandleHistory(string securityName, TimeFrame tf) => null;
        ...
        /// </summary>
        void CancelAllOrders(Security security = null);

        /// <summary>
        /// take my trades
        /// взять мои сделки
        /// </summary>
        Queue<MyTrade> MyTrades { get; }
