...
// синглетон
    ...
    public class WebhookThreadSaveSender
    {
        ...
        public void Send(string webhook, Log message, string botName, byte[] file = null)
        {
            try
            {
        ...
        private void SendDiscordMessage(string webhook, Log message, string botName, byte[] file = null)
        {
        ...
        /// <param name="message"> log message / сообщение из лога </param>
        /// <param name="botName"> bot name / имя бота </param>
        private DiscordMessage DiscordPayload(Log message, string botName)
        {
        ...
        /// <param name="botName"> bot name / имя бота </param>
        /// <param name="file"> file (chart screenshot) / скриншот чарта </param>
        private void SendSlackMessage(string webhook, Log message, string botName, byte[] file = null)
        {
        ...
        /// <param name="message"> log message / сообщение из лога </param>
        /// <param name="botName"> bot name / имя бота </param>
        private SlackMessage SlackPayload(Log message, string botName)
        {
        ...
        /// <param name="message"> log message / сообщение из лога </param>
        /// <param name="botName"> bot name / имя бота </param>
        private void SendTelegramMessage(string webhook, Log message, string botName)
        {
        ...
        /// <param name="message"> log message / сообщение из лога </param>
        /// <param name="botName"> bot name / имя бота </param>
        private TelegramMessage TelegramPayload(Log message, string botName)
        {
        ...
        /// <param name="message"> log message / сообщение из лога </param>
        /// <param name="botName"> bot name / имя бота </param>
        private void SendRawMessage(string webhook, Log message, string botName)
        {
        ...
        /// <param name="message"> log message / сообщение из лога </param>
        /// <param name="botName"> bot name / имя бота </param>
        private RawMessage RawPayload(Log message, string botName)
        {
        ...
        private string MessageColor(Log message, string format = "hexadecimal")
        {
            string hexColor;
        ...
        private string MessageEntityCode(Log message)
        {
            string entityCode;
        ...
        private string FormattedMessage(Log message)
        {
            return message.Message;
        }

        private string FormattedMessageType(Log message)
        {
